...
<html>
 ...
 <body>
  <div class="container box">
   <h1 align="center">PHP PDO Ajax CRUD z  bazą danych i front Bootstrap.</h1>
   <br />
   <div class="table-responsive">
    <br />
    <div align="right">
     <button type="button" id="add_button" data-toggle="modal" data-target="#userModal" class="btn btn-info btn-lg">Dodaj</button>
    </div>
    <br /><br />
